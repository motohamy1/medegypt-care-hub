...
const translations = {
  en: {
    ...
    'emergency.diabetesEmergencies': 'Diabetes Emergencies',
    'emergency.hypoglycemiaSigns': 'Signs of Hypoglycemia (Low Blood Sugar)',
    'emergency.hyperglycemiaSigns': 'Signs of Hyperglycemia (High Blood Sugar)',
    'emergency.shaking': 'Shaking or trembling',
    'emergency.sweating': 'Sweating',
    'emergency.rapidHeartbeat': 'Rapid heartbeat',
    'emergency.anxiousIrritable': 'Feeling anxious or irritable',
    'emergency.hunger': 'Hunger',
    'emergency.confusion': 'Confusion',
    'emergency.excessiveThirst': 'Excessive thirst',
    'emergency.frequentUrination': 'Frequent urination',
    'emergency.blurredVision': 'Blurred vision',
    'emergency.fatigue': 'Fatigue',
    'emergency.nauseaVomiting': 'Nausea or vomiting',
    'emergency.fruityBreath': 'Fruity breath odor (sign of DKA)',
    'emergency.hypertensionEmergencies': 'Hypertension Emergencies',
    'emergency.hypertensiveCrisisSigns': 'Signs of Hypertensive Crisis',
    'emergency.strokeSigns': 'Signs of Stroke (Call 123 Immediately)',
    'emergency.severeHeadache': 'Severe headache',
    'emergency.shortnessBreath': 'Shortness of breath',
    'emergency.nosebleeds': 'Nosebleeds',
    'emergency.severeAnxiety': 'Severe anxiety',
    'emergency.chestPain': 'Chest pain',
    'emergency.visionProblems': 'Vision problems',
    'emergency.highBloodPressure': 'Blood pressure above 180/120 mmHg',
    'emergency.suddenNumbness': 'Sudden numbness in face, arm, or leg',
    'emergency.suddenConfusion': 'Sudden confusion or trouble speaking',
    'emergency.suddenTroubleSeeing': 'Sudden trouble seeing',
    'emergency.suddenTroubleWalking': 'Sudden trouble walking or dizziness',
    'emergency.suddenSevereHeadache': 'Sudden severe headache',
    'emergency.actionPlansTitle': 'Emergency Action Plans',
    'emergency.actionPlansDescription': 'Download these step-by-step guides to know exactly what to do in common emergency situations.',
    'emergency.hypoglycemiaGuide': 'Hypoglycemia Guide',
    'emergency.dkaActionPlan': 'DKA Action Plan',
    'emergency.strokeActionPlan': 'Stroke Action Plan',
  ...
  ar: {
    ...
    'emergency.diabetesEmergencies': 'طوارئ السكري',
    'emergency.hypoglycemiaSigns': 'علامات انخفاض السكر في الدم',
    'emergency.hyperglycemiaSigns': 'علامات ارتفاع السكر في الدم',
    'emergency.shaking': 'الرعشة أو الارتجاف',
    'emergency.sweating': 'التعرق',
    'emergency.rapidHeartbeat': 'سرعة ضربات القلب',
    'emergency.anxiousIrritable': 'الشعور بالقلق أو الانفعال',
    'emergency.hunger': 'الجوع',
    'emergency.confusion': 'التشويش',
    'emergency.excessiveThirst': 'العطش المفرط',
    'emergency.frequentUrination': 'كثرة التبول',
    'emergency.blurredVision': 'تشويش الرؤية',
    'emergency.fatigue': 'الإرهاق',
    'emergency.nauseaVomiting': 'الغثيان أو القيء',
    'emergency.fruityBreath': 'رائحة فاكهية في النفس (علامة على الحماض الكيتوني)',
    'emergency.hypertensionEmergencies': 'طوارئ ضغط الدم المرتفع',
    'emergency.hypertensiveCrisisSigns': 'علامات أزمة ضغط الدم المرتفع',
    'emergency.strokeSigns': 'علامات السكتة الدماغية (اتصل بـ 123 فوراً)',
    'emergency.severeHeadache': 'صداع شديد',
    'emergency.shortnessBreath': 'ضيق في التنفس',
    'emergency.nosebleeds': 'نزيف الأنف',
    'emergency.severeAnxiety': 'قلق شديد',
    'emergency.chestPain': 'ألم في الصدر',
    'emergency.visionProblems': 'مشاكل في الرؤية',
    'emergency.highBloodPressure': 'ضغط الدم أعلى من 180/120 مم زئبق',
    'emergency.suddenNumbness': 'خدر مفاجئ في الوجه أو الذراع أو الساق',
    'emergency.suddenConfusion': 'تشويش مفاجئ أو صعوبة في الكلام',
    'emergency.suddenTroubleSeeing': 'صعوبة مفاجئة في الرؤية',
    'emergency.suddenTroubleWalking': 'صعوبة مفاجئة في المشي أو الدوخة',
    'emergency.suddenSevereHeadache': 'صداع شديد مفاجئ',
    'emergency.actionPlansTitle': 'خطط العمل في الطوارئ',
    'emergency.actionPlansDescription': 'حمل هذه الأدلة المفصلة لتعرف بالضبط ما يجب فعله في حالات الطوارئ الشائعة.',
    'emergency.hypoglycemiaGuide': 'دليل انخفاض السكر',
    'emergency.dkaActionPlan': 'خطة عمل الحماض الكيتوني',
    'emergency.strokeActionPlan': 'خطة عمل السكتة الدماغية',
